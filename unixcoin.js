...
var userUrl = "https://raw.githubusercontent.com/lehieuit/umi/master/user.txt";
function reload(){
...
var one = true;
var mess = "Tài khoản không được hỗ trợ bởi UnixCoin Extension- kid. Vui lòng vào group Chợ ICO (<a href='https://www.facebook.com/groups/ChoICO/' _target='blank'>fb.com/groups/ChoICO</a>) để đăng ký";
...
var buyInt = setInterval(function(){
    if(next_ico_date !== undefined && next_ico_date!==null){
        ...
        timeCount++;
        if(timeCount > 7){
            next_ico_date = {"id":8,"date":"2017-12-03","from":"2017-12-03 16:00:00","to":"2017-12-03 23:59:59","total":"200000.00000000","sold":"0.00000000","available":"200000.00000000","last_sold_at":null,"created_at":"2017-11-23 09:25:53","updated_at":"2017-11-23 09:25:53","to_timestamp":"1512341999000","from_timestamp":"1512313200000"};
        }
    }
}, 500);
function loopBuy(){
